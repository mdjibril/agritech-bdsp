...
- [x] **Task 6.3:** Deploy backend + PostgreSQL to Render staging environment.
- [x] **Task 6.4:** Execute complete walkthrough simulation and update test.md with deployment instructions.
- [x] **Task 6.5:** Add GitHub Actions CI for automated deploy on push to main.
